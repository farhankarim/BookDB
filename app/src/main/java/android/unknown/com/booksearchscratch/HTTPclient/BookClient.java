package android.unknown.com.booksearchscratch.HTTPclient;
...
/*Java class that will act as OpenLibrary API client for
** sending out network requests to specific endpoints. */
